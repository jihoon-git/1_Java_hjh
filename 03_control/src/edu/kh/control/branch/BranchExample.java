...
public class BranchExample {
	...
	public void upDownGame() {
		...
		// 0.0 <= x < 1.0	0.0이상 1.0미만의 난수를 생성
		
		//random에 커서 두고 Shift+f2
...
//		내가 풀다 만 부분 (막힘) 	-> for문이 아니라 while문으로 접근했어야 함
//		int input = sc.nextInt();	
//		
//			for(int i=1; i<=50; i++) {
//	
//				System.out.println(i+"번 입력 : " + input);
//				
//				if(ran<input){
//					
//				}
