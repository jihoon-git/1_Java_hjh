...
public class MapService {
	 ...
	 * 		-> Set의 특징을 지님(순서X, 중복X, equals(), hashCode()오버라이딩 O)
	 * 
...
//		map.put(key, value) : Map에 추가
	...
	public void ex2() {
		...
		Student std = new Student(); // vo
		Map<String, Object> student = new HashMap<String, Object>(); // map
		
		// 값 추가
		std.setName("홍길동"); // vo (value object)
		...
		System.out.println(student.get("adress"));
		...
		for(String key : student.keySet()) // 향상된 for문
						// Set<String>
